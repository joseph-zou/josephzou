...
const Navbar = () => {
  return (
    <>
      <div className="p-5 px-4 gap-x-10 flex flex-col flex-wrap font-serif justify-between items-center md:flex-row md:px-16 md:p-8 md:gap-x-0">
        <Link to="/" className="text-2xl md:text-3xl">
          Joseph Zou
        </Link>
        <div className="flex gap-3 text-base sm:text-lg md:text-xl md: flex-row">
